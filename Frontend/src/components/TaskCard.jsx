...
const TaskCard = ({
    ...
    return (
        <div className='bg-white rounded-xl mt-2  py-4 shadow-md shadow-gray-100 border border-gray-200/50 cursor-pointer'
        // onClick={onClick}
        >
            ...
            <div className={`px-4 border-l-[3px] ${status === "InProgress" ?
                "border-cyan-500"
                : status === "Completed" ?
                    "border-indigo-500"
                    : "border-violet-500"
